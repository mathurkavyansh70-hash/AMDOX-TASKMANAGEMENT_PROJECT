...
import com.TaskManagement.TaskManagement3.Service.FileAttachmentService;
...
public class FileAttachmentController {
	...
	public ResponseEntity<List<FileAttachment>>getFileByIssueId(@PathVariable Long id){
		
		return ResponseEntity.ok(attachmentService.getFileByIssueId(id));
